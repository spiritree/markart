<template>
  <div class="about" :class="{'mobile': mobileLayout}" style="padding-top: 3rem;">
    <div class="title" >
    ...
    <div class="info-box" :class="{'info-mobile': mobileLayout}">
      <div class="info ">
        <div class="list">
          ...
          <span class="list-content">spiritree, A Web engineer.</span>
        </div>
        <div class="list">
          <i class="iconfont icon-like"></i>
          <span class="list-content">Code and Game</span>
        </div>
        <div class="list">
          <i class="iconfont icon-comments"></i>
          <span class="list-content icons">
            <a href="mailto:spiritreess@gmail.com" target="_blank"><i class="iconfont icon-email"></i></a>
            <a href="https://github.com/spiritree" target="_blank"><i class="iconfont icon-github"></i></a>
            <!-- <a href="https://juejin.im/s" target="_blank"><i class="iconfont icon-juejin"></i></a> -->
            <a href="https://weibo.com/s" target="_blank"><i class="iconfont icon-weibo"></i></a>
            <!-- <a href="" target="_blank"><i class="iconfont icon-twitter"></i></a> -->
            <!-- <a href="https://segmentfault.com/u/s" target="_blank"><i class="iconfont icon-sf"></i></a> -->
            <a
            href="javascript:;"
            class="wechat"
